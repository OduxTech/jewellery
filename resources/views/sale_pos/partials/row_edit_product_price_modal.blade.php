        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6 @if (!$edit_discount) hide @endif">
                    ...
                    <input type="text" class="form-control price_after_discount" readonly>
                </div>
                <div class="form-group col-xs-12 col-sm-6 @if (!$edit_discount) hide @endif">
                    <label>Minimum Selling Price</label>
                    <input type="text" class="form-control minimum_selling_price"
                        value="{{ @num_format($product->minimum_selling_price ?? 0) }}" readonly>
                </div>
                @if (!empty($discount))
                    <div class="form-group col-xs-12">
